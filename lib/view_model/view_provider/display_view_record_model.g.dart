...
final displayValueProvider = AutoDisposeAsyncNotifierProvider<DisplayValue,
    DisplayViewRecordModel>.internal(
  DisplayValue.new,
  name: r'displayValueProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$displayValueHash,
  dependencies: null,
