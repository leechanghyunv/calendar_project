...
extension CalendarTimeModelPatterns on CalendarTimeModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CalendarTimeModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime selected, DateTime focused)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CalendarTimeModel() when $default != null:
        return $default(_that.selected, _that.focused);
      case _:
        return orElse();
    }
  }
