...
mixin _$WorkHistory {
 ...
 int? get id;@DateTimeConverter() DateTime get date; int get pay; double get record; String get colorCode; String get comment; String get memo; String get workSite; int get subsidy; bool get settlement; int get afterTax;
...
@useResult
$Res call({
 int? id,@DateTimeConverter() DateTime date, int pay, double record, String colorCode, String comment, String memo, String workSite, int subsidy, bool settlement, int afterTax
});
...
/// Create a copy of WorkHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? date = null,Object? pay = null,Object? record = null,Object? colorCode = null,Object? comment = null,Object? memo = null,Object? workSite = null,Object? subsidy = null,Object? settlement = null,Object? afterTax = null,}) {
...
as bool,afterTax: null == afterTax ? _self.afterTax : afterTax // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @DateTimeConverter()  DateTime date,  int pay,  double record,  String colorCode,  String comment,  String memo,  String workSite,  int subsidy,  bool settlement,  int afterTax)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkHistory() when $default != null:
return $default(_that.id,_that.date,_that.pay,_that.record,_that.colorCode,_that.comment,_that.memo,_that.workSite,_that.subsidy,_that.settlement,_that.afterTax);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @DateTimeConverter()  DateTime date,  int pay,  double record,  String colorCode,  String comment,  String memo,  String workSite,  int subsidy,  bool settlement,  int afterTax)  $default,) {final _that = this;
switch (_that) {
case _WorkHistory():
return $default(_that.id,_that.date,_that.pay,_that.record,_that.colorCode,_that.comment,_that.memo,_that.workSite,_that.subsidy,_that.settlement,_that.afterTax);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @DateTimeConverter()  DateTime date,  int pay,  double record,  String colorCode,  String comment,  String memo,  String workSite,  int subsidy,  bool settlement,  int afterTax)?  $default,) {final _that = this;
switch (_that) {
case _WorkHistory() when $default != null:
return $default(_that.id,_that.date,_that.pay,_that.record,_that.colorCode,_that.comment,_that.memo,_that.workSite,_that.subsidy,_that.settlement,_that.afterTax);case _:
  return null;
...
class _WorkHistory extends WorkHistory {
  const _WorkHistory({this.id, @DateTimeConverter() required this.date, this.pay = 0, this.record = 1.0, this.colorCode = '2196F3', this.comment = '정상근무', this.memo = '', this.workSite = '', this.subsidy = 0, this.settlement = false, this.afterTax = 0}): super._();
...
@override@JsonKey() final  int afterTax;
...
/// Create a copy of WorkHistory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? date = null,Object? pay = null,Object? record = null,Object? colorCode = null,Object? comment = null,Object? memo = null,Object? workSite = null,Object? subsidy = null,Object? settlement = null,Object? afterTax = null,}) {
