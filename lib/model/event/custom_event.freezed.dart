...
mixin _$CustomEvent {
 ...
 int get id;@DateTimeConverter() DateTime get date; String get name;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CustomEvent&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.name, name) || other.name == name));
}
...
@useResult
$Res call({
 int id,@DateTimeConverter() DateTime date, String name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @DateTimeConverter()  DateTime date,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomEvent() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @DateTimeConverter()  DateTime date,  String name)  $default,) {final _that = this;
switch (_that) {
case _CustomEvent():
return $default(_that.id,_that.date,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @DateTimeConverter()  DateTime date,  String name)?  $default,) {final _that = this;
switch (_that) {
case _CustomEvent() when $default != null:
return $default(_that.id,_that.date,_that.name);case _:
  return null;
...
class _CustomEvent implements CustomEvent {
  const _CustomEvent({this.id = 0, @DateTimeConverter() required this.date, this.name = ''});
  factory _CustomEvent.fromJson(Map<String, dynamic> json) => _$CustomEventFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$CustomEventToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CustomEvent&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.name, name) || other.name == name));
}
