...
mixin _$SearchHistoryModel {
 ...
 double get total; double get tax; double get afterTax; double get record; double get severancePay; int get wrd;///  근로신고일수
 int get workDay; double get workload;
...
@useResult
$Res call({
 double total, double tax, double afterTax, double record, double severancePay, int wrd, int workDay, double workload
});
...
/// Create a copy of SearchHistoryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? total = null,Object? tax = null,Object? afterTax = null,Object? record = null,Object? severancePay = null,Object? wrd = null,Object? workDay = null,Object? workload = null,}) {
...
as double,severancePay: null == severancePay ? _self.severancePay : severancePay // ignore: cast_nullable_to_non_nullable
as double,wrd: null == wrd ? _self.wrd : wrd // ignore: cast_nullable_to_non_nullable
as int,workDay: null == workDay ? _self.workDay : workDay // ignore: cast_nullable_to_non_nullable
as int,workload: null == workload ? _self.workload : workload // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double total,  double tax,  double afterTax,  double record,  double severancePay,  int wrd,  int workDay,  double workload)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchHistoryModel() when $default != null:
return $default(_that.total,_that.tax,_that.afterTax,_that.record,_that.severancePay,_that.wrd,_that.workDay,_that.workload);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double total,  double tax,  double afterTax,  double record,  double severancePay,  int wrd,  int workDay,  double workload)  $default,) {final _that = this;
switch (_that) {
case _SearchHistoryModel():
return $default(_that.total,_that.tax,_that.afterTax,_that.record,_that.severancePay,_that.wrd,_that.workDay,_that.workload);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double total,  double tax,  double afterTax,  double record,  double severancePay,  int wrd,  int workDay,  double workload)?  $default,) {final _that = this;
switch (_that) {
case _SearchHistoryModel() when $default != null:
return $default(_that.total,_that.tax,_that.afterTax,_that.record,_that.severancePay,_that.wrd,_that.workDay,_that.workload);case _:
  return null;
...
class _SearchHistoryModel implements SearchHistoryModel {
  const _SearchHistoryModel({this.total = 0.0, this.tax = 0.0, this.afterTax = 0.0, this.record = 0.0, this.severancePay = 0.0, this.wrd = 0, this.workDay = 0, this.workload = 0.0});
...
@override@JsonKey() final  double severancePay;
@override@JsonKey() final  int wrd;
///  근로신고일수
@override@JsonKey() final  int workDay;
@override@JsonKey() final  double workload;
...
/// Create a copy of SearchHistoryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? total = null,Object? tax = null,Object? afterTax = null,Object? record = null,Object? severancePay = null,Object? wrd = null,Object? workDay = null,Object? workload = null,}) {
