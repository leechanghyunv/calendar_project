...
extension RangeSelectedModelPatterns on RangeSelectedModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RangeSelectedModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool startSelected, bool endSelected)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RangeSelectedModel() when $default != null:
        return $default(_that.startSelected, _that.endSelected);
      case _:
        return orElse();
    }
  }
