...
extension DecimalFormPatterns on DecimalForm {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DecimalForm value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DecimalInput decimalData, DecimalFormzStatus status)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DecimalForm() when $default != null:
        return $default(_that.decimalData, _that.status);
      case _:
        return orElse();
    }
  }
